// frontend/src/modules/Movements/views/IngresoForm.jsx
...
const IngresoForm = ({ mode }) => {
    ...
    const [usuarioId, setUsuarioId] = useState(3); // (Sigue simulado, cámbialo por el usuario logueado)
    ...
    useEffect(() => {
        const cargarDatos = async () => {
            try {
                ...
                // (Opcional) Poner la primera sucursal como seleccionada por defecto
    ...
    const handleSubmit = async (e) => {
        ...
        if (!sucursalId || parseInt(sucursalId) === 0) {
            setError("Error: Debes seleccionar una sucursal de ingreso.");
            setLoading(false);
            return; 
        }
    ...
    return (
        <div className="main-container p-6 md:p-10">
            {/* ... (Tu cabecera y botón regresar no cambian) ... */}
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-3xl font-bold text-gray-800">Crear Nota de Ingreso</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <fieldset className="border p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Sucursal de Ingreso</label>
                            <select 
                                value={sucursalId} 
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Origen (Proveedor/Sede)</label>
                            <input type="text" value={origen} onChange={(e) => setOrigen(e.target.value)} className={textInputStyles} placeholder="Ej: GamarraCity S.A.C." />
                        </div>
                    </div>
                </fieldset>
